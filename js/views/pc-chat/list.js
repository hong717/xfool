define("views/pc-chat/list", [ "xlib/xEvent", "xlib/xString", "xlib/xCtrl", "xlib/xUtils",
        "xlib/xArray", "xlib/xObject", "xlib/xDate", "xApp", "views/chat/chat", "view/xView" ],
    function (require, exports, module) {
        ...
        var msgTxtId = 'viewid-pc-chat-msg';

        var config;
        //消息重复获取标志 用groupid 来做key
        var repeat = 0;
        ...
        function init(vPage) {
            viewPage = vPage;
            chatView = document.getElementById('viewid-pc-chat-list');
            chatList = $(chatView);
        ...
        //刷新聊天窗口，滚动条置底
        function refresh() {
            var list = document.getElementById('viewid-pc-chat-list');
        ...
        function repeatCall(repeat) {
            setTimeout(function () {
                if (repeat == config.groupid) {
                    checkMsgSend();
                    Chat.get({
                        groupid: config.groupid,
